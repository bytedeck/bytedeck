...
![The Advanced section of Site Configuration, with the two Library settings](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/14-settings-library.png)
...
![The Library entry in the sidebar](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/00-sidebar-library.png)
...
![The Library page, Quests tab](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/01-library-quests-tab.png)

Click any row to expand a preview of that quest, with an **Import Quest** button:

![An expanded quest preview with its Import Quest button](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/02-quest-preview.png)
...
![The Library page, Campaigns tab](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/05-library-campaigns-tab.png)
...
![A Library campaign's contents, with a quest expanded](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/18-campaign-detail.png)
...
4. A confirmation page shows the quest exactly as it will arrive, including its XP, tags and prerequisites. Click the green **Import**.
   ...
   ![The quest import confirmation page](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/03-import-quest-confirm.png)

5. You land on your **Drafts** tab, where the quest is waiting.

   ![The message shown after importing a quest](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/04-import-quest-result.png)
...
3. Confirm on the next page.
   ...
   ![The campaign import confirmation page](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/06-import-campaign-confirm.png)

4. You land on your **Inactive** campaigns tab, where the campaign is waiting.

   ![The message shown after importing a campaign](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/07-import-campaign-result.png)
...
* **A quest you already imported cannot be imported again.** The confirmation page tells you so and links to your copy, and the Import button is disabled. If you want the Library's version back, delete your copy first. If you want a *second* copy, use the **Copy** button on your own quest.
  ...
  ![The refusal shown when your deck already has the quest](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/16-import-already-have.png)
...
* **Importing a campaign containing quests you already imported individually will overwrite those quests** with the Library's versions. You lose local edits to their text, name, tags and questions. Your own prerequisites on them, and whether you had published them, are kept.
  ...
  ![The warning shown when a campaign import would overwrite quests you already have](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/15-import-campaign-overwrite-warning.png)
...
1. Open the quest on your deck. In its row of action buttons, click the upload button (**Export this quest to the Library**).
   ...
   ![The share button in a quest's row of action buttons](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/08-share-button.png)

2. The **Export Quest to Library** page shows the licence and the quest as it will be shared.

   ![The Export Quest to Library page](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/09-share-quest-confirm.png)

3. Tick the licence agreement and click **Share Quest to Library**.

   ![The message shown after sharing a quest](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/10-share-quest-result.png)
...
1. Open the campaign, or find it in your Campaigns list, and click the upload button (**Export this Campaign to the Library**).
   ...
   ![The share button on a campaign](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/11-share-campaign-button.png)

2. Tick the licence agreement and click **Share Campaign to Library**.

   ![The Export Campaign to Library page](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/12-share-campaign-confirm.png)

   ![The message shown after sharing a campaign](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/13-share-campaign-result.png)
...
![The refusal shown when the Library already has the quest](https://raw.githubusercontent.com/bytedeck/bytedeck/pr-assets/wiki/images/library/17-share-already.png)
