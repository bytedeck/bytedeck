...
def create_users():
    ...
    User.objects.create_superuser(
        username=settings.TENANT_DEFAULT_ADMIN_USERNAME, email=settings.TENANT_DEFAULT_ADMIN_EMAIL, password=settings.TENANT_DEFAULT_ADMIN_PASSWORD
    )
    # OWNER OF THE DECK
    ...
    owner.set_password(
        settings.TENANT_DEFAULT_OWNER_PASSWORD,
    )
    owner.save()
...
def create_initial_grades():
    Grade.objects.create(name='8', value=8)
    Grade.objects.create(name='9', value=9)
    Grade.objects.create(name='10', value=10)
    Grade.objects.create(name='11', value=11)
    Grade.objects.create(name='12', value=12)
...
def create_initial_badge_types():
    ...
    BadgeType.objects.create(
        name='Award', sort_order=2, description='Awards are badges that are manually granted by teachers.', repeatable=True, fa_icon='fa-diamond'
    )
    BadgeType.objects.create(
        name='Team',
        sort_order=3,
...
def create_initial_badge_rarities():
    BadgeRarity.objects.create(name='Common', percentile=100.0, color='gray', fa_icon='fa-certificate')
    BadgeRarity.objects.create(name='Uncommon', percentile=30.0, color='green', fa_icon='fa-certificate')
    BadgeRarity.objects.create(name='Rare', percentile=16.0, color='royalblue', fa_icon='fa-certificate')
    BadgeRarity.objects.create(name='Epic', percentile=4.0, color='purple', fa_icon='fa-certificate')
    BadgeRarity.objects.create(name='Legendary', percentile=1.0, color='orangered', fa_icon='fa-certificate')
    BadgeRarity.objects.create(name='Mythic', percentile=0.25, color='gold', fa_icon='fa-certificate')
