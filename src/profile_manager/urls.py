...
urlpatterns = [
    ...
    re_path(r'^(?P<profile_id>[0-9]+)/archive/$', views.profile_archive, name='profile_archive'),
    re_path(r'^(?P<profile_id>[0-9]+)/restore/$', views.profile_restore, name='profile_restore'),
