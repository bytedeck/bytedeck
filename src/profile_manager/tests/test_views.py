...
class ProfileViewTests(TestCase):
    ...
    def test_all_profile_page_status_codes_for_students(self):
        ...
        self.assertEquals(self.client.get(reverse('profiles:profile_detail', args=[s2_pk])).status_code, 302)
        ...
        self.assertEquals(self.client.get(reverse('profiles:profile_update', args=[s2_pk])).status_code, 404)
    ...
    def test_profile_recalculate_xp_status_codes(self):
        ...
        self.assertEquals(self.active_sem.pk, djconfig.config.hs_active_semester)
