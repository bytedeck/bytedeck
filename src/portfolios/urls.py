...
urlpatterns = [
    ...
    url(r'^(?P<uuid>[0-9a-f]+)/$', views.public, name='public'),
    url(r'^(?P<pk>[0-9]+)/edit/$', views.PortfolioUpdate.as_view(), name='update'),

    url(r'^art/create/(?P<doc_id>[0-9]+)$', views.art_create, name='art_add'),
