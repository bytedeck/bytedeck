...
class SemesterModelTest(TenantTestCase):
    def setUp(self):
        ...
        self.semester = baker.make(Semester, first_day=self.semester_start, last_day=self.semester_end)
...
class CourseStudentManagerTest(TenantTestCase):
    ...
    def test_calc_semester_grades__student_with_negative_xp(self, xp_per_course):
        ...
        self.assertRaises(ValueError, CourseStudent.objects.calc_semester_grades, Semester.objects.get_current())
