...
class SiteConfig(models.Model):
    ...
    students_choose_xp_course = models.BooleanField(
        ...
        default=True,
        help_text="When a student in more than one course hands in a quest, they say which course it counts toward. Turn this off to share every \
            student's XP evenly between their courses instead. Students in a single course are never asked either way, and work handed in before \
            this was turned on stays evenly shared."
    )
