...
class SiteConfig(models.Model):
    ...
    site_name = models.CharField(
        verbose_name='Site Name, Full',
        default='My Byte Deck',
        max_length=50,
    ...
    banner_image = models.ImageField(
        verbose_name='Banner Image', null=True, blank=True, help_text='The image will be displayed at the top left of the site 262px wide'
    )

    banner_image_dark = models.ImageField(
        verbose_name='Banner Image, Dark Theme', null=True, blank=True, help_text='An optional, alternate banner to be used with the dark theme.'
    )

    site_logo = models.ImageField(
        verbose_name='Site Logo', null=True, blank=True, help_text="This will be displayed at the top left of your site's header (ideally 64x64 px)."
    )

    default_icon = models.ImageField(
        verbose_name='Default Icon',
        null=True,
        blank=True,
    ...
    submission_quick_text = models.CharField(
        verbose_name='Submission Quick Text',
        blank=True,
        max_length=255,
    ...
    blank_approval_text = models.CharField(
        verbose_name='Approved without Comment Text',
        blank=True,
        max_length=255,
    ...
    blank_return_text = models.CharField(
        verbose_name='Returned without Comment Text',
        blank=True,
        max_length=255,
    ...
    banned_from_comments_text = models.CharField(
        verbose_name='Banned from Announcement Comments Text',
        max_length=255,
    ...
    outgoing_email_signature = models.TextField(
        verbose_name='Outoging Email Signature',
        blank=True,
        max_length=512,
    ...
    deck_ai = models.ForeignKey(
        ...
        verbose_name='User for automated stuff',
        default=get_superadmin,
    ...
    color_headers_by_mark = models.BooleanField(
        verbose_name='Activate Header Colors by Mark', default=False, help_text='Set up at least one Mark Range in admin for this to do anything.'
    )
    ...
    approve_oldest_first = models.BooleanField(
        verbose_name='Sort quests awaiting approval with oldest on top',
        default=False,
    ...
    enable_shared_library = models.BooleanField(
        verbose_name='Enable Shared Library', default=False, help_text='If enabled, you can import quests and campaigns from the Shared Library.'
    )
    ...
    custom_javascript = RestrictedFileField(
        null=True,
        blank=True,
        content_types=['application/x-javascript', 'application/javascript', 'text/javascript'],
        max_upload_size=512000,
    ...
    deck_owner = models.ForeignKey(
        User,
        on_delete=models.PROTECT,
        default=get_default_deck_owner,
        limit_choices_to={'is_staff': True},
