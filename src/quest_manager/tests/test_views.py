...
class QuestViewTests(TestCase):
    ...
    def test_all_quest_page_status_codes_for_students(self):
        ...
        self.assertEqual(self.client.get(reverse('quests:quest_create')).status_code, 302)
        self.assertEqual(self.client.get(reverse('quests:quest_update', args=[q_pk])).status_code, 302)

        self.assertEqual(self.client.get(reverse('quests:quest_copy', args=[q_pk])).status_code, 302)
        self.assertEqual(self.client.get(reverse('quests:quest_delete', args=[q_pk])).status_code, 302)
