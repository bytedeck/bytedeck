...
def load_orientation_campaign(apps, schema_editor):
    ...
    if orientation_campaign and Quest.objects.count() == 1 and Quest.objects.filter(import_id="bee53060-c332-4f75-85e1-6a8f9503ebe1").exists():
        ...
        cc_quest = Quest.objects.create(
            ...
            short_description="Who owns your digital art? Who owns your code? Who owns your creations? This quest teaches you a bit about copyright and introduces you to Creative Commons.",
        ...
        # Can't use this method because it makes a 'fake' prereq model thast doesn't have access to our `add_simple_prereq` class method
        # Prereq = apps.get_model('prerequisites', 'Prereq')
