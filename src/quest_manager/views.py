...
from .forms import (QuestForm, SubmissionForm, SubmissionFormCustomXP, SubmissionFormStaff,
                    SubmissionQuickReplyForm, TAQuestForm, CommonQuestInfoForm)
from .models import Quest, QuestSubmission, Category, CommonQuestInfo
...
@method_decorator(staff_member_required, name='dispatch')
class CommonQuestInfoListView(ListView):
    model = CommonQuestInfo
    template_name = "quest_manager/common_quest_info_list.html"


@method_decorator(staff_member_required, name='dispatch')
class CommonQuestInfoCreateView(CreateView):
    model = CommonQuestInfo
    form_class = CommonQuestInfoForm
...
@method_decorator(staff_member_required, name='dispatch')
class CommonQuestInfoUpdateView(UpdateView):
    model = CommonQuestInfo
    form_class = CommonQuestInfoForm
    template_name = "quest_manager/common_quest_info_form.html"
    success_url = reverse_lazy("quest_manager:commonquestinfo_list")
...
@method_decorator(staff_member_required, name='dispatch')
class CommonQuestInfoDeleteView(DeleteView):
    model = CommonQuestInfo
