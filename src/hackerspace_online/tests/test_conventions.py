...
LEGACY_UNCONVENTIONAL = {
    ...
    "comments/tests/test_template_tags.py",
    "comments/tests/test_views.py",
    "courses/tests/test_models.py",
    "courses/tests/test_template_tags.py",
    ...
    "notifications/tests/test_template_tags.py",
    "notifications/tests/test_views.py",
    "portfolios/tests/test_models.py",
    "portfolios/tests/test_template_tags.py",
    "portfolios/tests/test_views.py",
    "prerequisites/tests/test_admin.py",
    ...
    "profile_manager/tests/test_admin.py",
    ...
    "quest_manager/tests/test_admin.py",
