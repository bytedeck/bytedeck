...
def generate_quests(num_quest_per_campaign=10, num_campaigns=5, quiet=False):
    ...
    for _i in range(num_campaigns):
        ...
        initial_quest = Quest.objects.create(name=namegenerator.gen(), xp=random.randint(0, 20), campaign=new_campaign)
        ...
        for _j in range(num_quest_per_campaign - 1):
            quest = Quest.objects.create(name=namegenerator.gen(), xp=random.randint(0, 20), campaign=new_campaign)
