...
* Codebase:
  ...
  - Archiving a semester works out each student's per-course XP once rather than once per course they are in, and writes the graded rows in one go [#2459](https://github.com/bytedeck/bytedeck/issues/2459)
