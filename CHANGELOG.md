...
* Codebase:
  ...
  - Extended the contributor documentation that guides Claude Code sessions in this repository: building a real test environment rather than reading the code, replying on a review thread before resolving it, filing an issue for every suggestion left undone, watching a pull request on a timer instead of a stream of raw events, linking GitHub references in chat, saying which population each roster query means, and requesting automated code reviews on a schedule that respects the shared rate limit [#2307](https://github.com/bytedeck/bytedeck/issues/2307) [#2311](https://github.com/bytedeck/bytedeck/issues/2311) [#2361](https://github.com/bytedeck/bytedeck/issues/2361) [#2407](https://github.com/bytedeck/bytedeck/issues/2407) [#2421](https://github.com/bytedeck/bytedeck/issues/2421) [#2434](https://github.com/bytedeck/bytedeck/issues/2434) [#2466](https://github.com/bytedeck/bytedeck/issues/2466) [#2472](https://github.com/bytedeck/bytedeck/issues/2472) [#2515](https://github.com/bytedeck/bytedeck/issues/2515)
